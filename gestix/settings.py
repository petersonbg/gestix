...
from gestix.network_info import get_network_info, required_hosts
...
for required_origin in (
    _network_info.recommended_url,
    _network_info.mdns_url,
    f'http://localhost:{_network_info.port}',
    f'http://127.0.0.1:{_network_info.port}',
):
