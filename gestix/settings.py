...
BACKUP_ROOT = Path(os.getenv('BACKUP_ROOT', BASE_DIR / 'backups')).resolve()
BACKUP_MAX_UPLOAD_SIZE = int(os.getenv('BACKUP_MAX_UPLOAD_SIZE', 500 * 1024 * 1024))
RUNNING_IN_DOCKER = os.getenv('RUNNING_IN_DOCKER', 'False').lower() in {
    '1', 'true', 'yes', 'on',
}
