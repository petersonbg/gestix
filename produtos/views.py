...
from accounts.permissions import PerfilRequiredMixin, usuario_tem_perfil
...
class ProdutoListView(LoginRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['pode_manter_produtos'] = usuario_tem_perfil(
            self.request.user,
            [
...
class ProdutoManutencaoMixin(PerfilRequiredMixin):
    perfis_permitidos = (
        PerfilUsuario.Perfil.ADMINISTRADOR,
        PerfilUsuario.Perfil.GERENTE,
        PerfilUsuario.Perfil.VENDEDOR,
...
class ProdutoCreateView(LoginRequiredMixin, ProdutoManutencaoMixin, CreateView):
    model = Produto
    form_class = ProdutoForm
    template_name = 'produtos/produto_form.html'


class ProdutoUpdateView(LoginRequiredMixin, ProdutoManutencaoMixin, UpdateView):
    model = Produto
    form_class = ProdutoForm
    template_name = 'produtos/produto_form.html'


class ProdutoDeleteView(LoginRequiredMixin, ProdutoManutencaoMixin, DeleteView):
    model = Produto
