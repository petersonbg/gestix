...
from gestix.network_info import get_network_info
...
class AdministracaoHomeView(AdministracaoPermissaoMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['rede'] = get_network_info()
        return context


class DiagnosticoRedeView(AdministracaoPermissaoMixin, TemplateView):
    template_name = 'administracao/diagnostico_rede.html'
