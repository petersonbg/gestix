...
class OrdemServicoTests(TestCase):
    ...
    def test_imprimir_os(self):
        ...
        self.assertContains(response, 'Responsável pela Execução')
        ...
        self.assertContains(response, 'class="assinaturas page-break"')
        self.assertContains(response, '<div class="assinatura-box">', count=2)
        self.assertContains(response, '<div class="linha-assinatura"></div>', count=2)
        self.assertContains(response, 'assinatura-imagem')
