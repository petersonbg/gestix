    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid() and servicos_formset.is_valid() and produtos_formset.is_valid():
            ...
            with transaction.atomic():
                ...
                registrar_log(request.user, 'CRIACAO' if nova else 'EDICAO', 'ordens_servico', f'OS {ordem.numero}.', objeto=ordem, request=request)
...
def concluir(request, pk):
    ...
    try:
        ...
        registrar_log(request.user, 'FINALIZACAO', 'ordens_servico', f'OS {ordem.numero} concluída.', objeto=ordem, request=request)
...
def cancelar(request, pk):
    ...
    try:
        ...
        registrar_log(request.user, 'CANCELAMENTO', 'ordens_servico', f'OS {ordem.numero} cancelada.', objeto=ordem, request=request)
...
def imprimir(request, pk):
    ...
    registrar_log(request.user, 'IMPRESSAO', 'ordens_servico', f'OS {ordem.numero} impressa.', objeto=ordem, request=request)
    context = {'ordem': ordem}
