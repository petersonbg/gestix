...
class Venda(models.Model):
    ...
    class Meta:
        ordering = ['-data']
        indexes = [
            models.Index(fields=['status', 'data'], name='vendas_status_data_idx'),
            models.Index(fields=['usuario', 'status', 'data'], name='vendas_user_status_data_idx'),
        ]
        verbose_name = 'venda'
...
class ItemVenda(models.Model):
    ...
    class Meta:
        indexes = [
            models.Index(fields=['produto', 'venda'], name='item_produto_venda_idx'),
        ]
