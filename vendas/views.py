...
class VendaUpdateView(VendaCreateView):
    ...
    def post(self, request, pk):
        ...
        if form.is_valid() and formset.is_valid():
            ...
            registrar_log(request.user, 'EDICAO', 'vendas', f'Venda #{venda.pk} atualizada.', objeto=venda, request=request)
            return redirect(venda.get_absolute_url())
...
class VendaFinalizarView(LoginRequiredMixin, View):
    ...
    def post(self, request, pk):
        ...
        try:
            ...
            registrar_log(request.user, 'FINALIZACAO', 'vendas', f'Venda #{venda.pk} finalizada com baixa de estoque.', objeto=venda, request=request)
        return redirect(venda.get_absolute_url())
...
class VendaPrintView(LoginRequiredMixin, DetailView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        registrar_log(
            request.user, 'IMPRESSAO', 'vendas',
            f'Recibo da venda #{self.object.pk} visualizado para impressão.',
